...
export default function StationInput({ onSubmit, isLoading, onShowBusTimesClick, onQrScanClick, weatherData }: StationInputProps) {
    ...
    <Card className="border-zinc-200 dark:border-zinc-800">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row w-full items-center gap-2">
          <div className="flex w-full sm:w-auto items-center space-x-2 order-2 sm:order-1">
            {onShowBusTimesClick && (
              <TooltipProvider>
